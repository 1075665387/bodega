...
var ModeloInformeVeh = {};

//---------------------------------------------------------------
//obtenemos todo
ModeloInformeVeh.getInformeVeh = function (placa,f1,f2,callback)
{
    if (connection)
    {
        var sql = "SELECT id_envio, fecha_envio, destino, e.peso,nombre_mercancia as mercancia "
                        ...
                        +" WHERE v.placa_vehiculo = " + connection.escape(placa)
                        +" AND fecha_envio >= " + connection.escape(f1)
                        +" AND fecha_envio < " + connection.escape(f2)
                        +" ORDER BY destino;";
...
module.exports = ModeloInformeVeh;
